...
Este projeto tem como objetivo o desenvolvimento do site oficial da Igreja Presbiteriana Castelo Forte, servindo tanto como uma ferramenta de comunicação da igreja quanto como um ambiente prático de aprendizado em desenvolvimento full stack ao longo do ano, com foco especial no Basic Training Liferay.
 ...
 Ao longo do processo, este projeto contribui para o desenvolvimento de habilidades como estruturação de páginas web, organização de projetos reais, boas práticas de programação e uso de tecnologias voltadas para aplicações institucionais.

 A estrutura do projeto é simples e organizada, contendo um arquivo principal (index.html) e diretórios separados para estilos (css), scripts (js) e imagens.

 Entre as funcionalidades planejadas estão uma página inicial com identidade visual da igreja, uma área de eventos e avisos, integração com vídeos do YouTube, páginas informativas sobre ministérios e uma seção de contato.
